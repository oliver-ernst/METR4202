...
% the scene using given extrinsics, crops the image to the defined workspace
% Inputs:  intrinsics     - SPEC REQUIRED
%          extrinsics     - SPEC REQUIRED
%          scene_img      - unedited RGB scene image straight from ximera camera, read into array with
%                           size (1280,1024,3)
...
% Outputs: cyl            - 2 cell object, 1st cell has the centre point of the cylinder as (x,y), 2nd 
%                           cell has all boundary points for
%                           object as size (n,2) array of (x,y) points
%          cap            - same spec as cyl
%          clutter_bnds   - locations of the boundary points of the n amount of clutter objects in scene.
...
% Inputs:  cyl            - 2 cell object, 1st cell has the centre point of the cylinder as (x,y), 2nd 
%                           cell has all boundary points for object as size (n,2) array of (x,y) points
%          cap            - same spec as cyl
%          clutter_bnds   - locations of the boundary points of the n amount of clutter objects in scene.
%                           Array of (n,1) cells of boundary points.  These have a increased radius for 
%                           safety added.
